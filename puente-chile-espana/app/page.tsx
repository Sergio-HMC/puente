...
const services = [
  ...
  { icon: <Truck className="w-6 h-6" />, title: "Importación & logística", text: "Aranceles, Incoterms, 3PL, fulfilment y devoluciones." },
  ...
  { icon: <BadgeEuro className="w-6 h-6" />, title: "Localización fiscal", text: "IVA OSS, partners y primeros leads." },
...
const pricing = [
  {
    name: "Starter",
    price: "3.000-5.000 €",
    bullets: ["Análisis express (2-3 semanas)", "Plan de entrada y presupuesto", "Checklist regulatorio", "Estimador de costes"],
  },
  {
    name: "Landing",
    price: "8.000-15.000 €",
    bullets: ["Alta fiscal/societaria", "Registros + primer envío piloto", "Prueba de canal (marketplace o B2B)", "Agenda comercial inicial"],
  },
  {
    name: "Representación",
    price: "1.500-4.000 €/mes",
    bullets: ["Pipeline comercial y reuniones", "Reporting y back-office básico", "Gestión fiscal y legal", "Acceso a partners y red local"],
  },
];
    ...
    <main>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 mb-8">
              Tu socio local en España/UE: te acompañamos en lo legal, fiscal y logístico, y abrimos puertas comerciales
              para que tu negocio crezca sin fronteras.
              <br />
              <br />
            ...
            <div className="flex gap-4">
              <a
                href="#contacto"
                className="inline-flex items-center justify-center rounded-2xl px-5 py-2.5 shadow-sm transition bg-brand-primary text-white hover:opacity-90 gap-2"
              >
                Quiero evaluar mi entrada <ArrowRight className="w-4 h-4" />
              </a>
              <a
                href="#servicios"
                className="inline-flex items-center justify-center rounded-2xl px-5 py-2.5 shadow-sm transition text-brand-primary border border-brand-primary hover:bg-brand-cornsilk"
              >
                Ver servicios
              </a>
            </div>
          ...
          <div className="flex items-center justify-center">
            <Image
              src="/images/alianza.webp"  // asegúrate de subir esta imagen optimizada a /public/images/
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <h2 className="text-3xl font-bold text-brand-prussian mb-12">Por qué nosotros</h2>
      ...
      <section className="py-20 bg-slate-50" id="servicios">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <h2 className="text-3xl font-bold text-brand-prussian mb-12">Servicios</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((s, i) => (
      ...
      <section className="py-20 bg-white" id="precios">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <h2 className="text-3xl font-bold text-brand-prussian mb-12">Paquetes</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {pricing.map((p, i) => (
              <div key={i} className="p-6 bg-slate-50 rounded-2xl shadow-sm flex flex-col">
                ...
                <a
                  href="#contacto"
                  className="mt-6 inline-flex items-center justify-center rounded-2xl px-5 py-2.5 shadow-sm transition bg-brand-primary text-white hover:opacity-90"
                >
                  Quiero este plan
                </a>
              </div>
      ...
      {/* CONTACT */}
      <section className="py-20 bg-slate-50" id="contacto">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 text-center">
          <h2 className="text-3xl font-bold text-brand-prussian mb-6">Contacto</h2>
          <p className="text-slate-600 mb-8">
            Agenda una llamada con nuestro equipo y empieza tu camino hacia Europa.
          </p>
          <a
            href="#"
            className="inline-flex items-center justify-center rounded-2xl px-5 py-2.5 shadow-sm transition bg-brand-primary text-white hover:opacity-90"
          >
            Agendar llamada
          </a>
        </div>
